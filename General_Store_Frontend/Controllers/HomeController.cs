        ...
        public async Task<IActionResult> IndexAsync()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (Res.IsSuccessStatusCode)
                {
                    ...
                    //Deserializing the response recieved from web api and storing into the Products list  
                    ProductInfo = JsonConvert.DeserializeObject<List<Products>>(EmpResponse);

                }
                //returning top 3 Products only list to view  
                return View(ProductInfo.Take(3));
                // return View();
            }
        }
